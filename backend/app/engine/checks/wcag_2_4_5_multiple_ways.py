"""WCAG 2.4.5 — Mehrere Wege (alternative Zugangswege).

Gleiche Regel wie BITV 9.2.4.5: Es gibt mindestens zwei unterschiedliche
Zugangswege, um zu den Inhalten zu gelangen. Erkannte Mechanismen:
...
_TEST_ID = "WCAG_2_4_5_MULTIPLE_WAYS"
...
async def check_multiple_ways(ctx: CheckContext):
    """WCAG 2.4.5 — Weniger als zwei Zugangswege zu den Inhalten."""
