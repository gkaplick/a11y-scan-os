"""WCAG 2.5.3 — Beschriftung im Namen (Label in Name, Failure F96).

Gleiche Regel wie BITV 9.2.5.3: Die sichtbare Beschriftung eines
Bedienelements muss im zugänglichen Namen enthalten sein. Erkennt
Override-Fälle, in denen eine aria-label-/aria-labelledby-/title-Beschriftung
den sichtbaren Text übersteuert, ohne ihn zu enthalten.
...
_TEST_ID = "WCAG_2_5_3_LABEL_IN_NAME"
...
async def check_label_in_name(ctx: CheckContext):
    """WCAG 2.5.3 — Sichtbare Beschriftung fehlt im zugänglichen Namen."""
    errors = []
