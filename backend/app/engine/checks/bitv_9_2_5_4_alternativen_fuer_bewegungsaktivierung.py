"""BITV 9.2.5.4 — Alternativen für Bewegungsaktivierung.

WCAG 2.5.4 (A): Funktionen, die über Gerätebewegung ausgelöst werden
(Beschleunigungs-/Orientierungssensoren), brauchen alternative
Eingabemöglichkeiten und müssen abschaltbar sein (z. B. beim „Shake"-Geste
...
_TEST_ID = "BITV_9_2_5_4_ALTERNATIVEN_FUER_BEWEGUNGSAKTIVIERUNG"
...
async def check_alternativen_fuer_bewegungsaktivierung(ctx: CheckContext):
    """BITV 9.2.5.4 — Seite nutzt Gerätebewegung ohne nachweisbare Alternative."""
