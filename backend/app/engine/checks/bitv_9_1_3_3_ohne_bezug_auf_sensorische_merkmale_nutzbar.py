"""BITV 9.1.3.3 — Ohne Bezug auf sensorische Merkmale nutzbar.

WCAG 1.3.3 (A): Anweisungen dürfen sich nicht ausschließlich auf Farbe, Form
oder Position beziehen. Erkannt werden typische Formulierungen:
...
_TEST_ID = "BITV_9_1_3_3_OHNE_BEZUG_AUF_SENSORISCHE_MERKMALE_NUTZBAR"
...
async def check_ohne_bezug_auf_sensorische_merkmale_nutzbar(ctx: CheckContext):
    """BITV 9.1.3.3 — Anweisung nur über sensorische Merkmale (Position/Farbe)."""
    errors = []
