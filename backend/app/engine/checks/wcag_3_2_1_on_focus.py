"""WCAG 3.2.1 — Keine unerwartete Kontextänderung bei Fokus.

Gleiche Regel wie BITV 9.3.2.1, WCAG-2.1-Technik-Fails F22/F23: Beim Erhalten
des Fokus (bzw. beim Laden der Seite) wird automatisch ein neues Fenster
geöffnet, ein Formular abgeschickt oder zu einer anderen Seite navigiert.
...
async def check_on_focus(ctx: CheckContext):
    """WCAG 3.2.1 — Fokus/Laden löst Fenster-/Submit-/Navigations-Kontextänderung aus."""
    errors = []
