"""WCAG 2.1.4 — Tastaturkürzel (Einzelzeichen) abschaltbar/anpassbar.

Gleiche Regel wie BITV 9.2.1.4: Einzelzeichen-Kurzbefehle sind nur erlaubt,
wenn sie abschaltbar, anpassbar oder an einen Modifikator (Ctrl/Alt/Meta)
gebunden sind.

Der Check erkennt inline-JS-Handler (onkeydown/onkeypress/onkeyup), die ein
...
_TEST_ID = "WCAG_2_1_4_CHAR_SHORTCUTS"
...
async def check_char_shortcuts(ctx: CheckContext):
    """WCAG 2.1.4 — Einzelzeichen-Kurzbefehl ohne Modifikator/Abschaltung."""
    errors = []
