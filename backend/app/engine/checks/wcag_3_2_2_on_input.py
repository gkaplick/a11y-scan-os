"""WCAG 3.2.2 — Keine unerwartete Kontextänderung bei Eingabe.

Gleiche Regel wie BITV 9.3.2.2, WCAG-2.1-Technik-Fails F36/F37: Ein
Formularfeld (Auswahlliste, Checkbox, Radio, Textfeld) löst beim Ändern der
Eingabe automatisch eine Kontextänderung aus — etwa ein Auto-Submit des
Formulars oder eine Navigation (location.href).
...
async def check_on_input(ctx: CheckContext):
    """WCAG 3.2.2 — Formularfeld mit Auto-Submit/Navigation bei Eingabe."""
    errors = []
