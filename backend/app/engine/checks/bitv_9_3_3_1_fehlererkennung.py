"""BITV 9.3.3.1 — Fehlererkennung.

WCAG 3.3.1 (A): Fehler werden automatisch erkannt; das fehlerhafte Feld wird
identifiziert und der Fehler in Textform beschrieben.
...
_TEST_ID = "BITV_9_3_3_1_FEHLERERKENNUNG"
...
async def check_fehlererkennung(ctx: CheckContext):
    """BITV 9.3.3.1 — Formular mit novalidate ohne Fehler-Anzeige-Mechanismus."""
    errors = []
