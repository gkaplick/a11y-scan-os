"""WCAG 2.1.1 — Tastatur: alle Funktionen per Tastatur bedienbar.

Port des implementierten BITV-Checks 9.2.1.1 (gleicher Algorithmus,
anderer test_id). Erkennt Maus-only-Bedienelemente im statischen DOM:
...
sichtbar und bleiben der manuellen Prüfung überlassen. Reine
DOM-Analyse → Syntax-Check (keine Playwright-Seite nötig).
"""
from __future__ import annotations

from ._base import CheckContext, finding, get_dom_path, is_accessible_element

_TEST_ID = "WCAG_2_1_1_KEYBOARD"
...
async def check_keyboard(ctx: CheckContext):
    """WCAG 2.1.1 — Maus-only-Bedienelemente."""
    errors = []
