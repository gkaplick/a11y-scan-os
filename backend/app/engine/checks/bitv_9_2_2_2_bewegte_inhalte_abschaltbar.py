"""BITV 9.2.2.2 — Bewegte Inhalte abschaltbar.

Bewegende, blinkende oder selbstaktualisierende Inhalte, die länger als
5 Sekunden laufen, brauchen einen Abschalt-/Pause-/Ausblend-Mechanismus
(WCAG 2.2.2, F16/F47).
...
_TEST_ID = "BITV_9_2_2_2_BEWEGTE_INHALTE_ABSCHALTBAR"
...
async def check_bewegte_inhalte_abschaltbar(ctx: CheckContext):
    """BITV 9.2.2.2 — Bewegter Inhalt ohne Abschalt-/Pause-Mechanismus."""
    bewegt: list[tuple] = []
