"""WCAG 2.5.1 — Zeigergesten (Alternativen für komplexe Zeiger-Gesten).

Gleiche Regel wie BITV 9.2.5.1: Funktionen, die über pfadbasierte (Wisch-)
oder Mehrpunkt-Gesten (Pinch, Zwei-Finger) bedient werden, brauchen eine
...
_TEST_ID = "WCAG_2_5_1_POINTER_GESTURES"
...
async def check_pointer_gestures(ctx: CheckContext):
    """WCAG 2.5.1 — Seite nutzt komplexe Zeiger-Gesten ohne nachweisbare Alternative."""
