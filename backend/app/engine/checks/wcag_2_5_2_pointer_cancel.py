"""WCAG 2.5.2 — Zeigereingaben können abgebrochen oder widerrufen werden.

Gleiche Regel wie BITV 9.2.5.2 (A): Aktionen dürfen nicht bereits beim
Down-Event eines Zeigers ausgeführt werden — sonst gibt es keine Möglichkeit,
die Funktion abzubrechen oder rückgängig zu machen (G210-Fail). Gängige
Muster sind mousedown/pointerdown/touchstart-Handler, die direkt navigieren,
Fenster öffnen, Formulare abschicken oder Elemente anklicken.

Erkannt werden Down-Event-Handler, deren Code eine Kontextänderung/Aktion
auslöst. Die Ausnahme (Down-Auslösen essenziell, z. B. Zeichnen) ist statisch
nicht prüfbar — dokumentierte Grenze.
"""
...
_TEST_ID = "WCAG_2_5_2_POINTER_CANCEL"
...
async def check_pointer_cancel(ctx: CheckContext):
    """WCAG 2.5.2 — Down-Event-Trigger führt Aktion ohne Abbruch-Möglichkeit aus."""
    errors = []
