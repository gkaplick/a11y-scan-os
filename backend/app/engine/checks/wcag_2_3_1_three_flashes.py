"""WCAG 2.3.1 — Drei Blitze (Verzicht auf Flackern).

Gleiche Regel wie BITV 9.2.3.1: Seiteninhalte blitzen nicht häufiger als
dreimal pro Sekunde. Statisch erkennbar sind die klassischen Fehlerfälle:
...
_TEST_ID = "WCAG_2_3_1_THREE_FLASHES"
...
async def check_three_flashes(ctx: CheckContext):
    """WCAG 2.3.1 — Blink-Elemente/Blink-Decoration (Flackern > 3×/s)."""
    errors = []
