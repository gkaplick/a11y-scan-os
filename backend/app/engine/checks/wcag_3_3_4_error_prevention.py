"""WCAG 3.3.4 — Fehlervermeidung wird unterstützt (rechtliche/finanzielle Transaktionen).

Gleiche Regel wie BITV 9.3.3.4 (AA): Bei Transaktions-Formularen (finanzielle
oder rechtlich bindende Daten) muss die Eingabe rückgängig machbar sein oder
der Nutzer vor dem Abschicken die Möglichkeit erhalten, Eingaben zu prüfen und
zu korrigieren.
...
_TEST_ID = "WCAG_3_3_4_ERROR_PREVENTION"
...
async def check_error_prevention(ctx: CheckContext):
    """WCAG 3.3.4 — Transaktionsformular ohne Prüf-/Bestätigungs-Mechanismus."""
    errors = []
